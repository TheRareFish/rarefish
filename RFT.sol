 ...
 */
contract ERC20Burnable is ERC20RareQ {
 ...
 */
contract ERC20Mintable is ERC20RareQ, MinterRole {
 ...
 *
 */
contract ERC20RareD is ERC20RareQ, ERC20Burnable, ERC20Mintable, Pausable {
    ...
    constructor (
        ...
        ERC20RareQ(initialAccount, _tokenSymbol, _tokenName, initialBalance) {
